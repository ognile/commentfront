...
- [ ] Reel comment posting has a first-class automation path, not a disabled-post workaround. Verify locally by letting a reel page load, dumping interactive elements, opening its comment surface, typing, submitting, and visually verifying the posted comment.

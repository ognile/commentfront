...
## testing requirements (ALL must pass locally and pushed to GitHub before "done")

1. api calls work (curl commands)
2. frontend ALWAYS tested with Claude Chrome Extension — visual verification required for ALL UI changes
3. edge cases handled (errors, empty data, invalid input)

**frontend testing protocol:**
- EVERY frontend change requires visual verification via Claude Chrome Extension
- NEVER claim frontend is done without visual proof
